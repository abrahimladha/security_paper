...
\node[draw,shape = circle] (earth) {Earth};
\node[draw,shape = circle](mars) at (6,2) {Mars};
\node[draw, shape = circle](venus) at (2,6) {Venus};
...
\node[draw,shape = circle] (venus1) at (3,6) {};
\node[draw,shape = circle] (venus2) at (2.7,6.7) {};
\node[draw,shape = circle] (venus3) at (2,7) {};
...
\path (mars) edge (earth);
\path (venus) edge (earth);
\path (mars) edge (venus);
\end{tikzpicture}
...
\node[dashed,draw,shape = circle] (orbit2) at (3.6,0) {~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~};
\node[draw, shape = circle, fill= black](p2) at (3.6,0) {};
\node[fill=white,draw,shape = circle] (f1) at (-3,0){$p_1$};
\node[fill=white,draw,shape = circle] (f2) at (5.7,0){$p_2$};
